...
<title>Phoenix Pheet Running</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <header id="top">
                ...
                <h1 id="logo"><a href="<?php echo $page; ?>"><span class="hidden">Inset Pheet Logo</span></a></h1>
                
                <nav>
                	<ul>
                    	<li><a href="http://framework.gregbabula.info" class="<?php if ($page == 'index.php') { ?>active<?php } ?>">Home</a></li>
                        <li><a href="#" data-reveal-id="details-modal">Club Details</a></li>
        ...
        <section class="content">
            ...
            <div id="featured" class="btmspc">
                <img src="images/#" alt="Club Photo" />
                <img src="images/#" alt="Club Photo" data-caption="#caption-2" />
            ...
            <section class="cols vis-break brdr cntrtxt btmspc-dbl">
                ...
                <h1>Phoenix Pheet Running Club</h1>
            ...
            <section class="cols cols4 btmspc-dbl">
                ...
                <article class="col side-nav">
                    <h6>Favorite Races + Links to pages</h6>
                        <ul>
                            <li><a href="http://www.modernizr.com" target="_blank">P.f Changs + Rock and Roll </a></li>
                            <li><a href="http://meyerweb.com/eric/thoughts/2007/05/01/reset-reloaded" target="_blank">IMS Marathon</a></li>
                            <li><a href="http://docs.jquery.com/Downloading_jQuery" target="_blank">Whiskey Row</li>
                            <li><a href="http://www.css3pie.com" target="_blank">ARR Summer Series</a></li>
                            <li><a href="http://webdesignerwall.com/tutorials/css3-gradient-buttons" target="_blank">I-Did a Green Run</a></li>
                            <li><a href="http://cssglobe.com/post/9849/easy-percentage-grid-system-with-html5" target="_blank">Trail Runs</a></li>
                            <li><a href="http://ie6update.com" target="_blank">Ultra Events</a></li>
                            <li><a href="https://github.com/jaz303/tipsy" target="_blank">ARR Events</a></li>
                        </ul>
                </article>

                <aside class="col side-nav">
                    <h6>Weekly Group runs</h6>
                        <ul>
            ...
            <section class="cols vis-break brdr cntrtxt btmspc-dbl topspc">
                ...
                <a href="http://framework.gregbabula.info/assets/g5framework.zip" class="button orange tooltip btmspc" title="Download Zip"><img src="images/save_64.png" width="64" height="64" alt="Download Zip" /></a>
                   ...
                   <div id="details-modal" class="reveal-modal large">
                        ...
                        <h1 class="cntrtxt">Club Details</h1>

                        <h6 class="topspc-dbl">Group Runs</h6>
                            <ul>
                        ...
                        <h6 class="topspc">Distance Training</h6>
                            <ul>
